...
Neste repositório está presente uma pasta com o nome "NETWORK FILES" que guarda todos os scripts e metricas criados para a implementação da rede que posteriormente será integrada na API infernce engine da intel para ser executada com o ncs.
